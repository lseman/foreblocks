...
1. **input_preprocessor**:
   - This is a custom neural network module that can transform the input features before they're fed to the encoder
...
3. **Model Type**: The parameter `model_type` ("lstm" or "transformer") determines architecture details and how certain functions behave.
