...
const siteData = deserializeFunctions(JSON.parse('{"lang":"en-US","dir":"ltr","title":"foreBlocks","description":"Modular time-series forecasting, preprocessing, and architecture search for PyTorch","base":"/docs/","head":[],"router":{"prefetchLinks":true},"appearance":"force-dark","themeConfig":{"logo":"/logo.svg","nav":[],"sidebar":[{"text":"Start Here","items":[{"text":"Home","link":"/"},{"text":"Overview","link":"/overview"},{"text":"Getting Started","link":"/getting-started"}]},{"text":"Tutorials","collapsed":false,"items":[{"text":"Train A Direct Model","link":"/tutorials/train-direct-model"},{"text":"Run A DARTS Search","link":"/tutorials/darts-multifidelity-search"},{"text":"Generate Synthetic Series","link":"/tutorials/generate-synthetic-series"},{"text":"Optimize With BOHB","link":"/tutorials/optimize-with-bohb"}]},{"text":"Guides","collapsed":false,"items":[{"text":"Preprocessor","link":"/preprocessor"},{"text":"Custom Blocks","link":"/custom_blocks"},{"text":"Transformer","link":"/transformer"},{"text":"Mixture Of Experts","link":"/moe"},{"text":"Hybrid Mamba","link":"/hybrid-mamba"},{"text":"DARTS","link":"/darts"},{"text":"Evaluation & Metrics","link":"/evaluation"},{"text":"Uncertainty Quantification","link":"/uncertainty"},{"text":"Web UI","link":"/webui"},{"text":"Troubleshooting","link":"/troubleshooting"}]},{"text":"Foretools","collapsed":true,"items":[{"text":"Foretools Overview","link":"/foretools/index"},{"text":"Time Series Generator","link":"/foretools/tsgen"},{"text":"BOHB Search","link":"/foretools/bohb"},{"text":"VMD Decomposition","link":"/foretools/vmd"},{"text":"AutoDA Augmentation","link":"/foretools/tsaug"},{"text":"Feature Engineering","link":"/foretools/feature-engineering"}]},{"text":"Architecture","collapsed":true,"items":[{"text":"System Overview","link":"/architecture/system-overview"},{"text":"Forecasting Pipeline","link":"/architecture/forecasting-pipeline"},{"text":"DARTS Search Pipeline","link":"/architecture/darts-pipeline"}]},{"text":"Reference","collapsed":true,"items":[{"text":"Public API","link":"/reference/public-api"},{"text":"Configuration","link":"/reference/configuration"},{"text":"Repository Map","link":"/reference/repository-map"}]},{"text":"Contributing","collapsed":true,"items":[{"text":"Documentation Workflow","link":"/contributing/docs-workflow"}]}],"socialLinks":[{"icon":"github","link":"https://github.com/lseman/foreblocks"}],"editLink":{"pattern":"https://github.com/lseman/foreblocks/edit/main/docs/:path","text":"Edit this page on GitHub"},"footer":{"message":"MIT License","copyright":"Copyright © 2026 foreBlocks"}},"locales":{},"scrollOffset":134,"cleanUrls":false,"additionalConfig":{}}'));
...
async function renderMermaidDiagrams(isDark) {
  ...
  for (const diagram of diagrams) {
    const source = diagram.dataset.source ? decodeURIComponent(diagram.dataset.source) : diagram.textContent ?? "";
