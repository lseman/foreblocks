...
def check_step(device):
    ...
    for name, blk in [
        (
            "Mamba2",
            Mamba2Block(128, use_fused_path=False, use_triton_ssd=False, chunk_size=8),
        ),
...
def check_blocks(device):
    ...
    for name, blk in [
        (
            "Mamba2Block",
            Mamba2Block(
                d_model, use_fused_path=False, use_triton_ssd=False, chunk_size=64
            ),
        ),
    ...
    for T in (512, 2048):
        ...
        configs = [
            (
                "Mamba2 torch",
                Mamba2Block(
                    d_model, use_fused_path=False, use_triton_ssd=False, chunk_size=256
                ),
            ),
            (
                "Mamba2 triton",
                Mamba2Block(
                    d_model, use_fused_path=False, use_triton_ssd=True, chunk_size=256
                ),
            ),
            (
                "Mamba2 fused",
                Mamba2Block(
                    d_model, use_fused_path=True, use_triton_ssd=True, chunk_size=256
                ),
            ),
            (
                "Mamba3 torch",
