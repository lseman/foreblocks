...
from .aux import ModelConfig, TrainingConfig  # Your existing ModelConfig and TrainingConfig implementations
...
class TimeSeriesSeq2Seq:
    ...
    def _build_seq2seq_components(self) -> Tuple[Optional[nn.Module], Optional[nn.Module]]:
    ...
    def train_model(self, train_loader, val_loader=None, callbacks=None, plot_curves=True):
        """
    ...
    def evaluate_model(self, X_val, y_val):
        ...
        if self.trainer is None:
            raise ValueError("Model must be trained before evaluation. Call train_model first.")
